...
export const officialTimeline = [
  {
    ...
    note: "Pendaftaran dibuka untuk seluruh peserta dari dua divisi lomba.",
  },
  {
    date: "16 Juni 2026",
...
export const homeGallery: GalleryImage[] = [
  ...
  },
  {
    ...
    caption: "Visual panggung dan crowd membantu mempertegas identitas event teknologi nasional.",
  ...
  },
  {
    ...
    caption: "Dokumentasi yang menunjukkan ritme acara tetap aktif, hangat, dan terorganisir.",
  ...
  },
  {
    ...
    caption: "Momen kompetitif yang memperlihatkan keseriusan peserta selama babak berlangsung.",
...
export const cpGallery: GalleryImage[] = [
  {
    ...
    caption: "Atmosfer kompetitif terasa rapi, teknis, dan penuh fokus dari setiap tim peserta.",
  },
  {
    ...
    caption: "Galeri ini menonjolkan ritme lomba yang cepat, disiplin, dan sangat terukur.",
  },
  {
    ...
    caption: "Setiap frame memperlihatkan keseriusan peserta dalam membaca soal dan menyusun strategi.",
  },
  {
    ...
    caption: "Nuansa clean dan kompetitif tetap dijaga tanpa kehilangan karakter event teknologi.",
  },
];
...
export const uiuxGallery: GalleryImage[] = [
  {
    ...
    caption: "Suasana kerja peserta terasa aktif, kreatif, dan tetap terarah pada kualitas output.",
  },
  {
    ...
    caption: "Visual event membantu menegaskan bahwa cabang ini tetap kompetitif sekaligus product-oriented.",
  },
  {
    src: "/assets/inacomp/home/empat.jpg",
    ...
    caption: "Dokumentasi ini menjaga rasa acara tetap profesional, hidup, dan mudah dipercaya.",
  },
  {
    ...
    caption: "Komposisi visual panggung dan dokumentasi memperkuat positioning INACOMP sebagai event besar.",
  },
];
