        ...
        <div className="surface-card p-6 sm:p-8 lg:p-10">
          ...
          <div className="mt-8 grid gap-4 lg:grid-cols-3">
            {formatItems.map((item, index) => (
              <div key={item.title} className="rounded-[24px] border border-border bg-slate-50/80 p-6">
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-2xl bg-brand-indigo text-sm font-semibold text-white">
                  0{index + 1}
                </div>
