...
export function CPSecretSkills() {
  const skills = [
    { name: "Algorithmic Logic", desc: "Ketajaman dalam memilih algoritma yang paling efisien (time complexity)." },
    { name: "Code Robustness", desc: "Kemampuan menangani edge cases dan batasan input yang ekstrem." },
    { name: "Optimization Skill", desc: "Optimasi penggunaan memori dan kecepatan eksekusi program." },
    { name: "Technical Accuracy", desc: "Ketelitian dalam implementasi struktur data dan formula matematika." },
  ];
