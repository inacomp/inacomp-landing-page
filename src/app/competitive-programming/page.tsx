...
const rulesOverview = [
	...
	"Satu tim maksimal berisikan 2 peserta. Tidak bisa mendaftar sendiri.",
						...
						<div className="mx-auto mt-10 flex max-w-md justify-center">
							<Reveal delay={0.1}>
								<BookletCard
									...
									link="https://drive.google.com/file/d/1gxRUMxEbnHSLGUjoPWx_T5mbs1GezzH9/view?usp=sharing"
									accentColor="#2EC4A0"
