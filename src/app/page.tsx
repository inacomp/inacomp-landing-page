...
export const metadata: Metadata = {
	title: "INACOMP 2.0 | Informatics National Competition Nasional",
	description:
		"INACOMP 2.0 adalah Informatics National Competition, lomba informatika nasional untuk siswa SMA/SMK dengan cabang Competitive Programming dan Cisco Networking.",
	keywords: [
		"INACOMP",
		"INACOMP 2.0",
		"Informatics National Competition",
		"lomba informatika nasional",
		"lomba competitive programming SMA",
		"lomba competitive programming SMK",
		"lomba networking siswa",
		"kompetisi programming dan networking nasional",
	...
	openGraph: {
		title: "INACOMP 2.0 | Informatics National Competition Nasional",
		description:
			"Kompetisi nasional untuk siswa SMA/SMK di bidang Competitive Programming dan Cisco Networking dari BEM PTIK UNJ.",
		url: "/",
	...
	twitter: {
		...
		title: "INACOMP 2.0 | Informatics National Competition Nasional",
		description:
			"Lomba informatika nasional untuk siswa SMA/SMK dengan cabang Competitive Programming dan Cisco Networking.",
...
const galleryImages = [
	{
		...
		alt: "Suasana kompetisi INACOMP 1.0 bersama peserta lomba informatika nasional",
		heightClass: "h-52 sm:h-64",
	},
	{
		src: "/assets/inacomp/home/dua.png",
		alt: "Peserta INACOMP mengikuti rangkaian competitive programming dan networking",
		heightClass: "h-72 sm:h-80",
	},
	{
		src: "/assets/inacomp/home/empat.jpg",
		alt: "Dokumentasi kegiatan INACOMP sebagai kompetisi nasional bidang informatika",
		heightClass: "h-80 sm:h-96",
	},
	{
		src: "/assets/inacomp/home/lima.jpeg",
		alt: "Momen pelaksanaan INACOMP 1.0 untuk siswa SMA dan SMK",
		heightClass: "h-56 sm:h-64",
	},
	{
		src: "/assets/inacomp/home/enam.jpg",
		alt: "Galeri peserta dan panitia Informatics National Competition",
		heightClass: "h-72 sm:h-80",
	},
	{
		src: "/assets/inacomp/home/tujuh.jpg",
		alt: "Dokumentasi final dan penutupan INACOMP 1.0",
...
const homeStructuredData = {
	...
	"@graph": [
		...
		},
		{
			...
			name: "INACOMP 2.0",
			description:
				"Kompetisi nasional untuk siswa SMA/SMK/sederajat di bidang Competitive Programming dan Cisco Networking.",
			url: "https://inacomp.vercel.app/",
			...
			about: ["Competitive Programming", "Cisco Networking"],
		},
	],
};
		...
		<>
			...
			<div className="page-shell page-shell-home flex min-h-screen flex-col">
				...
				<div>
								...
								<div>
									...
									<div className="space-y-2">
										<h1 className="max-w-3xl font-mono text-4xl font-bold leading-tight tracking-tight text-foreground sm:text-5xl lg:text-7xl">
											INACOMP 2.0 | Informatics National Competition
										</h1>
									</div>
									<p className="max-w-2xl text-base leading-8 text-muted sm:text-lg">
										Informatics National Competition (INACOMP) merupakan
										kompetisi yang berfokus pada bidang pemrograman komputer dan
										jaringan komputer. Diselenggarakan oleh Badan Eksekutif
										Mahasiswa Prodi Pendidikan Teknik Informatika dan Komputer
										Universitas Negeri Jakarta, kompetisi ini diselenggarakan
										nasional dan ditujukan kepada siswa/i SMA/SMK/sederajat.
									</p>
								</div>
						...
						<div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
							<div className="space-y-5">
								...
								<h2 className="font-mono text-3xl font-bold leading-tight text-foreground sm:text-4xl lg:text-5xl">
									Kompetisi teknologi nasional untuk siswa/i SMA/SMK yang siap
									unjuk kemampuan.
								</h2>
								<p className="text-base leading-8 text-muted sm:text-lg">
									INACOMP 2.0 adalah edisi kedua dari Informatics National
									Competition — ajang tahunan yang membuka ruang bagi siswa/i
									SMA/SMK/sederajat untuk bersaing di bidang pemrograman
									komputer dan jaringan komputer di tingkat nasional.
								</p>
							</div>
					...
					<section id="cabang-lomba" className="px-4 py-20 sm:px-6 lg:px-8">
						<div className="mx-auto max-w-7xl space-y-10">
							<div className="max-w-3xl space-y-4">
								...
								<h2 className="font-mono text-3xl font-bold leading-tight text-foreground sm:text-4xl lg:text-5xl">
									Dua cabang lomba, satu kompetisi — pilih yang paling sesuai
									minatmu.
								</h2>
								<p className="text-base leading-8 text-muted sm:text-lg">
									Competitive Programming untuk yang suka algoritma, Cisco
									Networking untuk yang tertarik di dunia jaringan. Keduanya
									berskala nasional, keduanya menantang.
								</p>
							</div>
					...
					<section id="timeline" className="px-4 py-20 sm:px-6 lg:px-8">
						<div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2.75rem] border border-white/70 bg-[linear-gradient(180deg,_rgba(255,255,255,0.72),_rgba(239,247,246,0.78))] p-6 shadow-soft backdrop-blur-xl sm:p-8 lg:p-12">
							...
							<div className="max-w-3xl space-y-4">
								...
								<h2 className="font-mono text-3xl font-bold leading-tight text-foreground sm:text-4xl lg:text-5xl">
									Dari pendaftaran sampai grand final — ini jadwal lengkap
									INACOMP 2.0.
								</h2>
								<p className="text-base leading-8 text-muted sm:text-lg">
									Catat tanggalnya, siapkan timmu, dan pastikan tidak ada satu
									tahapan pun yang terlewat.
								</p>
							</div>
								...
								<div className="space-y-0">
									{timelineItems.map((item, index) => {
										...
										return (
											<div
												key={item.title}
												className="group relative py-10 sm:py-12 lg:py-16"
											>
												...
												{/* Content Row */}
												<div
													className={`flex pl-12 sm:pl-16 lg:pl-0 ${desktopAlign}`}
												>
					...
					<section id="galeri" className="px-4 py-20 sm:px-6 lg:px-8">
						<div className="mx-auto max-w-7xl space-y-10">
							<div className="max-w-3xl space-y-4">
								...
								<p className="text-base leading-8 text-muted sm:text-lg">
									Sekilas momen dari INACOMP 1.0 — dari sesi kompetisi sampai
									pengumuman juara.
								</p>
							</div>
					...
					<section id="faq" className="px-4 py-20 sm:px-6 lg:px-8">
						<div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
							<div className="space-y-4">
								...
								<p className="text-base leading-8 text-muted sm:text-lg">
									Beberapa pertanyaan yang sering muncul — jawaban singkat,
									langsung ke poinnya.
								</p>
							</div>
							...
							<div className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-center">
								<div className="space-y-5">
									...
									<p className="max-w-2xl text-base leading-8 text-white/80 sm:text-lg">
										Semua yang perlu kamu tahu — alur kompetisi, ketentuan
										peserta, dan informasi teknis — ada di guidebook
					...
					<section
						id="closing-cta"
						className="px-4 pb-20 pt-6 sm:px-6 lg:px-8 lg:pb-28"
					>
						<div className="mx-auto max-w-5xl rounded-[2.25rem] border border-white/80 bg-white/78 px-6 py-10 text-center shadow-soft backdrop-blur-sm sm:px-8 sm:py-12 lg:px-14">
							...
							<h2 className="mt-5 font-mono text-3xl font-bold leading-tight text-foreground sm:text-4xl lg:text-5xl">
								Saatnya pilih cabang lomba, siapkan guidebook, dan jadi bagian
								dari INACOMP 2.0.
							</h2>
							<p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-muted sm:text-lg">
								Masuk ke cabang yang paling sesuai dengan minatmu dan mulai
								persiapan dari sekarang untuk tampil maksimal di kompetisi
								nasional ini.
							</p>
