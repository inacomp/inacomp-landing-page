...
import { homeFaqItems, homeGallery, officialTimeline } from "@/lib/site-content";
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-4">
                    <h1 className="max-w-4xl text-balance text-4xl font-bold leading-[1] sm:text-5xl lg:text-6xl">
                      INACOMP 2.0 hadir sebagai kompetisi IT nasional yang lebih
                      <span className="text-brand-accent"> terstruktur, modern, dan meyakinkan.</span>
                    </h1>
                    <p className="max-w-2xl text-lg leading-8 text-muted">
                      Untuk pelajar SMA/SMK sederajat yang ingin tampil serius
                      melalui Competitive Programming dan UI/UX Design dalam satu
                      panggung kompetisi yang rapi, kuat, dan mudah dipahami.
                    </p>
                  </div>
                </div>
        ...
        <section id="timeline" className="section-space soft-section">
          <Container>
            <Reveal>
              <SectionIntro
                eyebrow="Timeline"
                title="Timeline umum INACOMP 2.0 untuk seluruh divisi lomba."
        ...
        <section className="section-space">
          <Container>
            <Reveal>
              <SectionIntro
                eyebrow="Gallery"
                title="Dokumentasi yang membangun rasa event."
                description="Galeri dipakai bukan sekadar pelengkap visual, tetapi sebagai bukti suasana, intensitas, dan kredibilitas penyelenggaraan kompetisi."
                align="center"
              />
            </Reveal>
                ...
                <div className="relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
                  <div className="max-w-2xl space-y-6">
                    ...
                    <p className="text-lg leading-relaxed text-muted">
                      Tim admin kami siap membantu menjelaskan detail teknis kompetisi, regulasi, atau kendala pendaftaran melalui WhatsApp.
                    </p>
                  </div>
        ...
        <section id="faq" className="section-space soft-section">
          <Container>
            <Reveal>
              <SectionIntro
                eyebrow="FAQ"
                title="Pertanyaan yang paling sering muncul sebelum peserta memutuskan ikut."
                ...
                <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                  <div className="space-y-4">
                    ...
                    <h2 className="max-w-3xl text-balance text-3xl font-bold sm:text-4xl lg:text-5xl">
                      Siap memilih cabang yang paling sesuai dengan cara timmu berpikir dan berkarya?
                    </h2>
                    <p className="max-w-2xl text-base leading-8 text-muted sm:text-lg">
                      Mulai dari halaman divisi lomba, pelajari formatnya, lalu
                      siapkan tim terbaikmu untuk masuk ke INACOMP 2.0.
                    </p>
                  </div>

                  <div className="flex flex-col gap-3">
                    <Link href="#tracks" className="primary-button">
                      Jelajahi Divisi Lomba
                    </Link>
                    <Link href="#timeline" className="secondary-button">
                      Cek Jadwal Resmi
                    </Link>
