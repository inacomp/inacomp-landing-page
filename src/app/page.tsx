...
const registrationCategories = [
  {
    title: "Competitive Programming",
    description:
      "UI tombol pendaftaran untuk cabang Competitive Programming sudah disiapkan. Link Google Form akan ditambahkan setelah form resmi tersedia.",
  },
  {
    title: "UI/UX Design",
    description:
      "UI tombol pendaftaran untuk cabang UI/UX Design sudah disiapkan. Link Google Form akan ditambahkan setelah form resmi tersedia.",
  },
] as const;
  ...
  return (
    <>
      ...
      <div className="page-shell">
        ...
        <section id="tracks" className="section-space soft-section">
          <Container>
            <Reveal>
              <SectionIntro
                eyebrow="Competition Tracks"
                title="Dua Cabang Lomba pada Kompetisi yang sama."
                description="Siapkan tim terbaikmu untuk berkompetisi pada kompetisi yang sama, dengan dua cabang lomba yang berbeda."
              />
            </Reveal>
          ...
          <Container>
            <div className="grid gap-10 lg:grid-cols-[0.86fr_1.14fr] lg:items-start">
              <Reveal>
                <SectionIntro
                  eyebrow="Why Join"
                  title="Masuki Pengalaman Kompetisi yang Lebih Kredibel Bersama INACOMP."
                  description="Juara hanyalah bonus. Fokus utama kami adalah membantu Anda membangun rasa percaya diri, memperkaya kualitas portofolio, serta memberikan pengalaman nyata berkompetisi di tingkat nasional."
                />
              </Reveal>
                ...
                {whyJoinItems.map((item, index) => {
                  ...
                  return (
                    <Reveal key={item.title} delay={0.05 * index}>
                      <article className="surface-card h-full p-5 transition-transform duration-200 hover:-translate-y-1 hover:border-brand-primary/35">
        ...
        <section id="timeline" className="section-space soft-section">
          <Container>
            <Reveal>
              <SectionIntro
                eyebrow="Timeline"
                title="Timeline umum INACOMP 2.0"
                description="Alur ini dipakai bersama oleh Competitive Programming dan UI/UX Design"
                align="center"
              />
            </Reveal>
                ...
                <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                  <div className="space-y-4">
                    ...
                    <h2 className="max-w-3xl text-balance text-3xl font-bold sm:text-4xl lg:text-5xl">
                      Sudah siap untuk berkompetisi dengan talenta hebat
                      lainnya? siapkan tim mu dan ikuti lombanya
                    </h2>
                    <p className="max-w-2xl text-base leading-8 text-muted sm:text-lg">
                      lalu siapkan tim terbaikmu untuk berkompetisi di INACOMP
                      2.0.
                    </p>
                  </div>
