                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-4">
                    <h1 className="max-w-4xl text-balance text-4xl font-bold leading-[1] sm:text-5xl lg:text-6xl">
                      ...
                      <span className="text-brand-accent"> riset, rancangan UI, dan prototype</span>
                  ...
                  <div className="grid gap-4">
                    <div className="surface-card p-5">
                      ...
                      <h2 className="mt-3 text-2xl font-bold">
                        Halaman ini harus terasa visual, rapi, dan product-oriented.
                      </h2>
                    ...
                    <div className="surface-card editorial-grid p-5">
                      <div className="grid gap-3 rounded-[16px] bg-white p-4 sm:grid-cols-[1.12fr_0.88fr]">
                        ...
                        <div className="rounded-[14px] border border-slate-200 bg-brand-soft/45 p-4">
                          <p className="text-sm font-semibold">Prototype preview</p>
        ...
        <section className="section-space">
          <Container>
            <Reveal>
              <SectionIntro
                eyebrow="Gallery"
                title="Visual yang mendukung rasa kompetisi, bukan sekadar dekorasi."
                description="Galeri dipakai untuk menjaga atmosfer event tetap terasa, sambil mempertahankan karakter cabang yang lebih kreatif dan product-oriented."
                align="center"
              />
            </Reveal>

            <Reveal delay={0.08} className="mt-10">
              <GalleryMosaic items={uiuxGallery} />
            </Reveal>
          </Container>
        </section>
        ...
        <section className="section-space soft-section">
          <Container>
            <Reveal>
              <SectionIntro
                eyebrow="FAQ"
                title="Pertanyaan yang paling relevan untuk calon peserta UI/UX Design."
                ...
                <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
                  <div className="space-y-4">
                    ...
                    <h2 className="max-w-3xl text-balance text-3xl font-bold sm:text-4xl lg:text-5xl">
                      Kalau timmu kuat di riset, struktur solusi, dan presentasi visual, cabang ini layak dipilih.
                    </h2>
                    <p className="max-w-2xl text-base leading-8 text-muted sm:text-lg">
                      Kembali ke halaman utama untuk melihat keseluruhan kompetisi,
                      lalu pastikan timmu siap menyiapkan proposal dan prototype.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <Link href="/competitive-programming" className="secondary-button">
